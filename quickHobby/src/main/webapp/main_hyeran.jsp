  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        ...
        <img src="${root}/img/bg05.jpg" alt="Chania">
      ...
      <div class="item">
        <img src="${root}/img/bg01.jpg" alt="Chania" >
        <div class="carousel-caption">
          <h3>Chania</h3>
          <p>The atmosphere in Chania has a touch of Florence and Venice.</p>
        </div>
      ...
      <div class="item">
        <img src="${root}/img/bg02.jpg" alt="Flower"  >
        <div class="carousel-caption">
          <h3>Flowers</h3>
      ...
      <div class="item">
        <img src="${root}/img/bg03.jpg" alt="Flower" >
        <div class="carousel-caption">
          <h3>Flowers</h3>
          <p>Beatiful flowers in Kolymbari, Crete.</p>
        </div>
       ...
       <div class="item">
        <img src="${root}/img/bg04.jpg" alt="Flower" >
        <div class="carousel-caption">
          <h3>Flowers</h3>
          <p>The atmosphere in Chania has a touch of Florence and Venice.</p>
        </div>
