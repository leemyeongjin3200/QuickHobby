...
// 	console.log(form.groupSubject.value);
	...
	if(form.groupCategory.value==""){
		...
		form.groupCategory[0].focus();
		return false;
	}
	
	if(form.groupInout.value==""){
		alert("You have to choose indoor or outdoor.");
		form.groupInout[0].focus();
		return false;
	}
	
	if(form.groupDate.value==""){
		alert("You have to choose the closing date.");
		form.groupDate.focus();
		return false;
	}
	
	if(form.groupSubject.value==""){
		alert("You have to input the title.");
		form.groupSubject.focus();
		return false;
	}
	
	if(form.groupSubtitle.value==""){
		alert("You have to input the subtitle.");
		form.groupSubtitle.focus();
		return false;
	}
	
	if(form.groupContent.value==""){
		alert("You have to input the content.");
		form.groupContent.focus();
		return false;
	}
}
