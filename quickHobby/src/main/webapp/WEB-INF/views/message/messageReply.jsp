...
<body>
	<!-- 쪽지 답장 정보를 입력하는 form -->
	<form action="${root}/message/messageReplyOk.do" method="post" onsubmit="return checkForm(this)">
		<input type="hidden" value="1" name="message_sender"/>
		<input type="hidden" value="${message_receiver}" name="message_receiver"/><br/>
